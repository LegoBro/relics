...
execute as @n[tag=card.entity,distance=..2,sort=nearest] run function cards:entity/get/stats

data modify storage helper:raycast/display actionbar merge value [{"score":{"name":"#armor","objective":"var"},"color":"gray","bold":true},{"translate":"🛡","color":"white","bold":false},{"text":" "},{"score":{"name":"#health","objective":"var"},"color":"red","bold":true},{"text":"/","color":"red","bold":false},{"score":{"name":"#maxHealth","objective":"var"},"color":"red","bold":true},{"translate":"♥","color":"white","bold":false},{"text":" "},{"score":{"name":"#attack","objective":"var"},"color":"dark_red","bold":true},{"translate":"🗡","color":"white","bold":false},{"text":" "},{"score":{"name":"#speed","objective":"var"},"color":"blue","bold":true},{"translate":"🥾","color":"white","bold":false},{"text":" "},{"score":{"name":"#range","objective":"var"},"color":"green","bold":true},{"translate":"🏹","color":"white","bold":false}]
