...
execute store result score #deck_amount var run data get block 0 0 0 Items[0].components."minecraft:custom_data".Save.Packs
...
execute store result score @s display run data get block 0 0 0 Items[0].components."minecraft:custom_data".Save.Packs[0]
