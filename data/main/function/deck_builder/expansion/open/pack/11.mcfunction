...
execute positioned ~-2.5 ~3.1 ~-2.5 run particle trial_spawner_detection ~ ~ ~ 0.15 0 0.15 0.0001 12 force
execute positioned ~2.5 ~3.1 ~-2.5 run particle trial_spawner_detection ~ ~ ~ 0.15 0 0.15 0.0001 2 force
execute positioned ~-2.5 ~3.1 ~2.5 run particle trial_spawner_detection ~ ~ ~ 0.15 0 0.15 0.0001 2 force
execute positioned ~2.5 ~3.1 ~2.5 run particle trial_spawner_detection ~ ~ ~ 0.15 0 0.15 0.0001 2 force
