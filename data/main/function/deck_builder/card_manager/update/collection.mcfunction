...
# Update GUI
execute at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.21 with coal[item_name={"translate":"collection.left","color":"white","italic":false}]
execute at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.23 with charcoal[item_name={"translate":"collection.right","color":"white","italic":false}]
execute if score @s menu matches 0..8 at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.22 with spyglass[item_name={"translate":"collection.search","color":"white","italic":false},lore=[{"translate":"collection.search.rarity","color":"gold","bold":false}]]
execute if score @s menu matches 10..18 at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.22 with spyglass[item_name={"translate":"collection.search","color":"white","italic":false},lore=[{"translate":"collection.search.cost","color":"green","bold":false}]]
execute if score @s menu matches 20..28 at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.22 with spyglass[item_name={"translate":"collection.search","color":"white","italic":false},lore=[{"translate":"collection.search.name","color":"blue","bold":false}]]
execute if score @s menu matches 30..38 at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.22 with spyglass[item_name={"translate":"collection.search","color":"white","italic":false},lore=[{"translate":"collection.search.type","color":"light_purple","bold":false}]]