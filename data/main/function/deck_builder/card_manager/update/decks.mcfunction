...
execute if score @s menu matches -1 at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.22 with leather[item_model=white_bundle,custom_data={gui:True,select:True},item_name={"translate":"decks.grab","color":"white","italic":false}]
execute if score @s menu matches -2 at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.22 with leather[item_model=red_bundle,custom_data={gui:True,select:True},item_name={"translate":"decks.grab","color":"red","italic":false}]
execute if score @s menu matches -3 at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.22 with leather[item_model=orange_bundle,custom_data={gui:True,select:True},item_name={"translate":"decks.grab","color":"gold","italic":false}]
execute if score @s menu matches -4 at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.22 with leather[item_model=yellow_bundle,custom_data={gui:True,select:True},item_name={"translate":"decks.grab","color":"yellow","italic":false}]
execute if score @s menu matches -5 at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.22 with leather[item_model=green_bundle,custom_data={gui:True,select:True},item_name={"translate":"decks.grab","color":"green","italic":false}]
execute if score @s menu matches -6 at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.22 with leather[item_model=cyan_bundle,custom_data={gui:True,select:True},item_name={"translate":"decks.grab","color":"aqua","italic":false}]
execute if score @s menu matches -7 at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.22 with leather[item_model=blue_bundle,custom_data={gui:True,select:True},item_name={"translate":"decks.grab","color":"dark_blue","italic":false}]
execute if score @s menu matches -8 at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.22 with leather[item_model=purple_bundle,custom_data={gui:True,select:True},item_name={"translate":"decks.grab","color":"dark_purple","italic":false}]
execute if score @s menu matches -9 at @e[type=marker,tag=id,tag=deck.builder.marker] run item replace block ~1 ~ ~ container.22 with leather[item_model=black_bundle,custom_data={gui:True,select:True},item_name={"translate":"decks.grab","color":"dark_gray","italic":false}]
