...
# New Cards
execute unless entity @s[tag=id,scores={turnCount=27..}] run function main:board/drafting/cards

scoreboard players add @s turnCount 1
execute unless entity @a[tag=id,scores={turnCount=..26}] run function main:board/drafting/begin_game
