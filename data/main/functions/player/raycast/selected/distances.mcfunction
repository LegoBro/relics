...
execute if score @s distance <= #speed var run item replace entity @s[tag=!filled] armor.head with book{CustomModelData:6}

execute if score @s distance <= #range var run item replace entity @s[tag=hostile] armor.head with book{CustomModelData:7}

execute if score @s distance matches 0 run item replace entity @s armor.head with book{CustomModelData:1}
