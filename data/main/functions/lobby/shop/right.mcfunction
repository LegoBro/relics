...
# New Left
scoreboard players operation @e[tag=shop.display.new_left,limit=1] display = @e[tag=shop.display.left] display
scoreboard players remove @e[tag=shop.display.new_left,limit=1] display 1
execute as @e[tag=shop.display.new_left,limit=1] run function main:lobby/shop/display/item
data merge entity @e[tag=shop.display.new_left,limit=1] {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[1f,0f,-0.5f],scale:[1f,1f,1f]},start_interpolation:0,interpolation_duration:3}
...
data merge entity @e[tag=shop.display.left_transition,limit=1] {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,-1f],scale:[2f,2f,2f]},start_interpolation:0,interpolation_duration:3}
item replace entity @e[tag=shop.display.left] container.0 with air
...
data merge entity @e[tag=shop.display.right_transition,limit=1] {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-1f,0f,-0.5f],scale:[0f,0f,0f]},start_interpolation:0,interpolation_duration:3}
item replace entity @e[tag=shop.display.right] container.0 with air

scoreboard players remove #shop display 1
