...
execute if entity @s[tag=is_friendly] as @n[type=armor_stand,tag=board,tag=id,distance=..1.5] run function card:helper/friendly

execute if entity @s[tag=!is_friendly] as @n[type=armor_stand,tag=board,tag=id,distance=..1.5] run function card:helper/hostile
