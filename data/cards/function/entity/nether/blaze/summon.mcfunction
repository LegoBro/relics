...
summon blaze ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","blaze","card.entity","card.nether","attackable"],Team:"green",data:{path:"entity/nether/blaze"}}
...
function cards:entity/nether/blaze/summon_display
