...
summon wither ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","wither","card.entity","card.nether","attackable"],Team:"green",data:{path:"entity/nether/wither"}}
