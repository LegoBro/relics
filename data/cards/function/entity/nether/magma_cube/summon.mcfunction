...
summon magma_cube ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","magma_cube","card.entity","card.nether","attackable"],Team:"green",data:{path:"entity/nether/magma_cube"},Size:2}
...
scoreboard players set @n[tag=get_id] attack 2
...
scoreboard players set @n[tag=get_id] apply_fire 1
tag @e[type=armor_stand,tag=board,tag=id,limit=1,sort=nearest] remove movable
tellraw @a[tag=id] [{"translate":"entity.spawns",with:[{"selector":"@s"},{"underlined":true,"translate":"card.magma_cube","hover_event":{"action":"show_item","id":"minecraft:carrot_on_a_stick","count":1,"components":{"minecraft:item_name":{"color":"green","translate":"card.magma_cube"},"minecraft:lore":[[{"sprite":"item/card/trait/fire",atlas:"items",color:white}],[{"translate":"cost","italic":false,"color":"white"},{"text":" 9","italic":false,"color":"white"},{"text":"        3 ","italic":false,"color":"white"},{"translate":"health","italic":false,"color":"white"}],[{"translate":"attack","italic":false,"color":"white"},{"text":" 2","italic":false,"color":"white"},{"text":"        0 ","italic":false,"color":"white"},{"translate":"armor","italic":false,"color":"white"}],[{"translate":"speed","italic":false,"color":"white"},{"text":" 1","italic":false,"color":"white"},{"text":"        1 ","italic":false,"color":"white"},{"translate":"range","italic":false,"color":"white"}],{"text":"","color":"white","italic":false},{"translate":"card.magma_cube.lore.0","color":"white","italic":false},{"translate":"card.magma_cube.lore.1","color":"white","italic":false},{"translate":"card.magma_cube.lore.2","color":"white","italic":false},{"translate":"card.magma_cube.lore.3","color":"white","italic":false}]}}}]}]
...
function cards:entity/nether/magma_cube/summon_display
