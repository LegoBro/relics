...
summon wither_skeleton ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","wither_skeleton","card.entity","card.nether","attackable"],Team:"green",data:{path:"entity/nether/wither_skeleton"},equipment:{mainhand:{id:'minecraft:stone_sword',count:1}}}
