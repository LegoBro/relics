...
summon piglin ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","piglin","card.entity","card.nether","attackable"],Team:"green",HandItems:[{id:'minecraft:crossbow',Count:1b},{}]}
