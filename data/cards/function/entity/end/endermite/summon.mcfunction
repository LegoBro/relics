...
summon endermite ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","endermite","card.entity","card.end","attackable"],Team:"green",data:{path:"entity/end/endermite"},PersistenceRequired:1b,PlayerSpawned:0b}
...
function cards:entity/end/endermite/summon_display
