...
summon armor_stand ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","ender_dragon","card.entity","card.end","attackable"],Team:"green",CustomName:"{\"text\":\"Ender Dragon\"}",Marker:1b,Invisible:1,DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:scute",Count:1b}]}
...
scoreboard players set @e[tag=get_id,limit=1,sort=nearest] health 15
scoreboard players set @e[tag=get_id,limit=1,sort=nearest] maxHealth 15
