...
summon armor_stand ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","end_crystal","card.entity","card.end","attackable"],Team:"green",data:{path:"entity/end/end_crystal"},CustomName:{"text":"End Crystal"},Marker:1b,Invisible:1,DisabledSlots:4144959,Passengers:[{id:"minecraft:end_crystal",Tags:["card.passenger"]}]}
...
tellraw @a[tag=id] [{"selector":"@s"},{text:" "},{"translate":"entity.spawns"},{text:" "},{"underlined":true,"translate":"card.end_crystal","hover_event":{"action":"show_item","id":"minecraft:carrot_on_a_stick","count":1,"components":{"minecraft:item_name":{"color":"green","translate":"card.end_crystal"},"minecraft:lore":[[{"translate":"cost","italic":false,"color":"white"},{"text":" 7","italic":false,"color":"white"},{"text":"        1 ","italic":false,"color":"white"},{"translate":"health","italic":false,"color":"white"}],[{"translate":"attack","italic":false,"color":"white"},{"text":" 0","italic":false,"color":"white"},{"text":"        0 ","italic":false,"color":"white"},{"translate":"armor","italic":false,"color":"white"}],[{"translate":"speed","italic":false,"color":"white"},{"text":" 0","italic":false,"color":"white"},{"text":"        0 ","italic":false,"color":"white"},{"translate":"range","italic":false,"color":"white"}],{"text":"","color":"white","italic":false},{"translate":"card.end_crystal.lore.0","color":"white","italic":false},{"translate":"card.end_crystal.lore.1","color":"white","italic":false},{"translate":"card.end_crystal.lore.2","color":"white","italic":false}]}}}]
