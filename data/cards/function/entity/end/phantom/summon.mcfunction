...
summon phantom ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","phantom","card.entity","card.end","attackable"],Team:"green",data:{path:"entity/end/phantom"},equipment:{head:{id:"minecraft:stone",count:1}}}
...
scoreboard players set @n[tag=get_id] attack 4
...
function cards:entity/end/phantom/summon_display
