...
summon enderman ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","enderman","card.entity","card.end","attackable"],Team:"green",data:{path:"entity/end/enderman"}}
...
scoreboard players set @n[tag=get_id] speed 4
...
function cards:entity/end/enderman/summon_display
