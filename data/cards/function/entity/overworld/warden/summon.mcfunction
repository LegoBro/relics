...
summon warden ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","warden","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/warden"}}
...
scoreboard players set @n[tag=get_id] health 20
scoreboard players set @n[tag=get_id] maxHealth 20
scoreboard players set @n[tag=get_id] attack 20
