...
summon goat ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","goat","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/goat"}}
...
function cards:entity/overworld/goat/summon_display
