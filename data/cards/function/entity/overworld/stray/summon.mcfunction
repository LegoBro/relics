...
summon stray ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","stray","card.entity","card.overworld","attackable"],Team:"green",equipment:{head:{id:"minecraft:book",count:1b}}}
