...
summon vex ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","vex","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/vex"}}
...
function cards:entity/overworld/vex/summon_display
