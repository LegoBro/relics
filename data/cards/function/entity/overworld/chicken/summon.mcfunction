...
summon chicken ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","chicken","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/chicken"}}
...
function cards:entity/overworld/chicken/summon_display
