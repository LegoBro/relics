...
summon wolf ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","wolf","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/wolf"}}
...
function cards:entity/overworld/wolf/summon_display
