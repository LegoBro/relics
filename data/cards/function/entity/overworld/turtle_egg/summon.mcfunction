...
summon armor_stand ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","turtle_egg","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/turtle_egg"},CustomName:{"text":"Turtle Egg"},Marker:1b,Invisible:1b,DisabledSlots:4144959}
...
scoreboard players set @n[tag=get_id] range 0
...
tellraw @a[tag=id] [{"selector":"@s"},{text:" "},{"translate":"entity.spawns"},{text:" "},{"underlined":true,"translate":"card.turtle_egg","hover_event":{"action":"show_item","id":"minecraft:carrot_on_a_stick","count":1,"components":{"minecraft:item_name":{"color":"green","translate":"card.turtle_egg"},"minecraft:lore":[[{"translate":"cost","italic":false,"color":"white"},{"text":" 2","italic":false,"color":"white"},{"text":"        1 ","italic":false,"color":"white"},{"translate":"health","italic":false,"color":"white"}],[{"translate":"attack","italic":false,"color":"white"},{"text":" 1","italic":false,"color":"white"},{"text":"        1 ","italic":false,"color":"white"},{"translate":"armor","italic":false,"color":"white"}],[{"translate":"speed","italic":false,"color":"white"},{"text":" 0","italic":false,"color":"white"},{"text":"        0 ","italic":false,"color":"white"},{"translate":"range","italic":false,"color":"white"}],{"text":"","color":"white","italic":false},{"translate":"card.turtle_egg.lore.0","color":"white","italic":false},{"translate":"card.turtle_egg.lore.1","color":"white","italic":false},{"translate":"card.turtle_egg.lore.2","color":"white","italic":false}]}}}]
...
function cards:entity/overworld/turtle_egg/summon_display
