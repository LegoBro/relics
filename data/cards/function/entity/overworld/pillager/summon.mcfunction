...
summon pillager ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","pillager","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/pillager"},equipment:{mainhand:{id:'minecraft:crossbow',count:1}}}
...
function cards:entity/overworld/pillager/summon_display
