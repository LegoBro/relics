...
summon spider ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","spider","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/spider"}}
...
function cards:entity/overworld/spider/summon_display
