...
summon creeper ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","charged_creeper","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/charged_creeper"},powered:1b}
...
scoreboard players set @n[tag=get_id] attack 7
...
tellraw @a[tag=id] [{"translate":"entity.spawns",with:[{"selector":"@s"},{"underlined":true,"translate":"card.charged_creeper","hover_event":{"action":"show_item","id":"minecraft:carrot_on_a_stick","count":1,"components":{"minecraft:item_name":{"color":"green","translate":"card.charged_creeper"},"minecraft:lore":[[{"sprite":"item/card/trait/ambush",atlas:"items",color:white}],[{"translate":"cost","italic":false,"color":"white"},{"text":" 9","italic":false,"color":"white"},{"text":"        3 ","italic":false,"color":"white"},{"translate":"health","italic":false,"color":"white"}],[{"translate":"attack","italic":false,"color":"white"},{"text":" 7","italic":false,"color":"white"},{"text":"        0 ","italic":false,"color":"white"},{"translate":"armor","italic":false,"color":"white"}],[{"translate":"speed","italic":false,"color":"white"},{"text":" 1","italic":false,"color":"white"},{"text":"        1 ","italic":false,"color":"white"},{"translate":"range","italic":false,"color":"white"}],{"text":"","color":"white","italic":false},{"translate":"card.charged_creeper.lore.0","color":"white","italic":false},{"translate":"card.charged_creeper.lore.1","color":"white","italic":false},{"translate":"card.charged_creeper.lore.2","color":"white","italic":false},{"translate":"card.charged_creeper.lore.3","color":"white","italic":false}]}}}]}]
...
function cards:entity/overworld/charged_creeper/summon_display
