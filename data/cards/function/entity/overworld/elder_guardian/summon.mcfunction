...
summon elder_guardian ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","elder_guardian","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/elder_guardian"}}
...
function cards:entity/overworld/elder_guardian/summon_display
