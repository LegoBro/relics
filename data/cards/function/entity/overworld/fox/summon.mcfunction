...
summon fox ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","fox","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/fox"}}
...
function cards:entity/overworld/fox/summon_display
