...
summon bogged ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","bogged","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/bogged"},equipment:{head:{id:"minecraft:book",count:1b}}}
