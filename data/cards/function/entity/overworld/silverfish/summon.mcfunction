...
summon silverfish ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","silverfish","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/silverfish"}}
...
tellraw @a[tag=id] [{"translate":"entity.spawns",with:[{"selector":"@s"},{"underlined":true,"translate":"card.silverfish","hover_event":{"action":"show_item","id":"minecraft:carrot_on_a_stick","count":1,"components":{"minecraft:item_name":{"color":"green","translate":"card.silverfish"},"minecraft:lore":[[{"sprite":"item/card/trait/arthropod",atlas:"items",color:white}],[{"translate":"cost","italic":false,"color":"white"},{"text":" 0","italic":false,"color":"white"},{"text":"        1 ","italic":false,"color":"white"},{"translate":"health","italic":false,"color":"white"}],[{"translate":"attack","italic":false,"color":"white"},{"text":" 1","italic":false,"color":"white"},{"text":"        0 ","italic":false,"color":"white"},{"translate":"armor","italic":false,"color":"white"}],[{"translate":"speed","italic":false,"color":"white"},{"text":" 1","italic":false,"color":"white"},{"text":"        1 ","italic":false,"color":"white"},{"translate":"range","italic":false,"color":"white"}],{"text":"","color":"white","italic":false},{"translate":"card.silverfish.lore.0","color":"white","italic":false},{"translate":"card.silverfish.lore.1","color":"white","italic":false},{"translate":"card.silverfish.lore.2","color":"white","italic":false},{"translate":"card.silverfish.lore.3","color":"white","italic":false},{"translate":"card.silverfish.lore.4","color":"white","italic":false}]}}}]}]
...
function cards:entity/overworld/silverfish/summon_display
