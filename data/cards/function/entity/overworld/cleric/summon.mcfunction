...
summon villager ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","cleric","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/cleric"},VillagerData:{profession:"minecraft:cleric"}}
...
tellraw @a[tag=id] [{"translate":"entity.spawns",with:[{"selector":"@s"},{"underlined":true,"translate":"card.cleric","hover_event":{"action":"show_item","id":"minecraft:carrot_on_a_stick","count":1,"components":{"minecraft:item_name":{"color":"green","translate":"card.cleric"},"minecraft:lore":[[{"sprite":"item/card/trait/emerald",atlas:"items",color:white}],[{"translate":"cost","italic":false,"color":"white"},{"text":" 13","italic":false,"color":"white"},{"text":"        4 ","italic":false,"color":"white"},{"translate":"health","italic":false,"color":"white"}],[{"translate":"attack","italic":false,"color":"white"},{"text":" 1","italic":false,"color":"white"},{"text":"        0 ","italic":false,"color":"white"},{"translate":"armor","italic":false,"color":"white"}],[{"translate":"speed","italic":false,"color":"white"},{"text":" 1","italic":false,"color":"white"},{"text":"        1 ","italic":false,"color":"white"},{"translate":"range","italic":false,"color":"white"}],{"text":"","color":"white","italic":false},{"translate":"card.cleric.lore.0","color":"white","italic":false},{"translate":"card.cleric.lore.1","color":"white","italic":false},{"translate":"card.cleric.lore.2","color":"white","italic":false}]}}}]}]
...
function cards:entity/overworld/cleric/summon_display
