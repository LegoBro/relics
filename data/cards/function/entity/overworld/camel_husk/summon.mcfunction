...
summon camel_husk ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","camel_husk","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/camel_husk"}}
...
scoreboard players set @n[tag=get_id] attack 6
...
scoreboard players remove @s saturation 18
function cards:entity/overworld/camel_husk/summon_display
