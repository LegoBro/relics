...
summon villager ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","librarian","card.entity","card.overworld","attackable"],Team:"green",VillagerData:{profession:"minecraft:librarian"}}
