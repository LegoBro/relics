...
summon frog ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","frog","card.entity","card.overworld","attackable"],Team:"green",data:{path:"entity/overworld/frog"}}
...
function cards:entity/overworld/frog/summon_display
