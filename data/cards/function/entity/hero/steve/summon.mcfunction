...
summon mannequin ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","steve","card.entity","card.hero","attackable"],Team:"green",data:{path:"entity/hero/steve"},profile:"MHF_Steve",equipment:{mainhand:{id:"minecraft:iron_pickaxe",count:1}}}
