...
execute positioned ~1 ~ ~ run function cards:consumable/defend/bee_nest/insert
...
execute positioned ~1 ~ ~ run function cards:consumable/defend/bee_hive/insert
...
execute positioned ~1 ~ ~ run function cards:consumable/defend/targets/insert
execute positioned ~1 ~ ~ run function cards:consumable/defend/cherry_sapling/insert
execute positioned ~1 ~ ~ run function cards:consumable/defend/farmland/insert