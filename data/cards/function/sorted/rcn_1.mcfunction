...
execute positioned ~1 ~ ~ run function cards:consumable/buff/honeycomb/insert
execute positioned ~1 ~ ~ run function cards:consumable/buff/flame_aspect/insert
execute positioned ~1 ~ ~ run function cards:entity/overworld/fletcher/insert
...
execute positioned ~1 ~ ~ run function cards:entity/nether/strider/insert
