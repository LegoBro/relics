...
tellraw @a[tag=id] {"translate":"cast.use",color:green,"with":[{"selector":"@s"},{"underlined":true,"translate":"card.sculk_shrieker","hover_event":{"action":"show_item","id":"minecraft:carrot_on_a_stick","count":1,"components":{"minecraft:item_name":{"color":"#018a73","translate":"card.sculk_shrieker"},"minecraft:lore":[[{"translate":"cost","italic":false,"color":"white"},{"text":" 7","italic":false,"color":"white"}],{"text":"","color":"white","italic":false},{"translate":"card.sculk_shrieker.lore.0","color":"white","italic":false},{"translate":"card.sculk_shrieker.lore.1","color":"white","italic":false},{"translate":"card.sculk_shrieker.lore.2","color":"white","italic":false},{"translate":"card.sculk_shrieker.lore.3","color":"white","italic":false},{"translate":"card.sculk_shrieker.lore.4","color":"white","italic":false}]}}}]}
