...
tellraw @a[tag=id] {"translate":"cast.use",color:green,"with":[{"selector":"@s"},{"underlined":true,"translate":"card.enchantment_table","hover_event":{"action":"show_item","id":"minecraft:carrot_on_a_stick","count":1,"components":{"minecraft:item_name":{"color":"#E0673A","translate":"card.enchantment_table"},"minecraft:lore":[[{"translate":"cost","italic":false,"color":"white"},{"text":" 7","italic":false,"color":"white"}],{"text":"","color":"white","italic":false},{"translate":"card.enchantment_table.lore.0","color":"white","italic":false},{"translate":"card.enchantment_table.lore.1","color":"white","italic":false},{"translate":"card.enchantment_table.lore.2","color":"white","italic":false}]}}}]}
