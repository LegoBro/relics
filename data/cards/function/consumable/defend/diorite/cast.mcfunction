...
tellraw @a[tag=id] [{"selector":"@s"},{"text":" uses "},{"underlined":true,"translate":"card.diorite","hover_event":{"action":"show_item","id":"minecraft:carrot_on_a_stick","count":1,"components":{"minecraft:item_name":{"color":"green","translate":"card.diorite"},"minecraft:lore":[[{"translate":"cost","italic":false,"color":"white"},{"text":" 9","italic":false,"color":"white"}],{"text":"","color":"white","italic":false},{"translate":"card.diorite.lore.0","color":"white","italic":false},{"translate":"card.diorite.lore.1","color":"white","italic":false},{"translate":"card.diorite.lore.2","color":"white","italic":false},{"translate":"card.diorite.lore.3","color":"white","italic":false}]}}}]
