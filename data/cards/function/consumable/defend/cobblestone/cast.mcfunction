...
tellraw @a[tag=id] [{"selector":"@s"},{text:" "},{"translate":"cast.use"},{text:" "},{"underlined":true,"translate":"card.cobblestone","hover_event":{"action":"show_item","id":"minecraft:carrot_on_a_stick","count":1,"components":{"minecraft:item_name":{"color":"green","translate":"card.cobblestone"},"minecraft:lore":[[{"translate":"cost","italic":false,"color":"white"},{"text":" 2","italic":false,"color":"white"}],{"text":"","color":"white","italic":false},{"translate":"card.cobblestone.lore.0","color":"white","italic":false},{"translate":"card.cobblestone.lore.1","color":"white","italic":false},{"translate":"card.cobblestone.lore.2","color":"white","italic":false}]}}}]
