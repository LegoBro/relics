...
summon armor_stand ~ ~1 ~ {CustomName:{"translate":"card.sculk_block"},Invisible:1b,Silent:1b,Invulnerable:1b,Tags:["new","get_id","id","card","sculk_block","card.building","card.defend","attackable"],Team:"green"}
