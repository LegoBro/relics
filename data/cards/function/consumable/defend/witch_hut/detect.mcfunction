...
execute as @e[type=armor_stand,tag=witch_hut,tag=id] at @s if entity @e[type=armor_stand,tag=board,tag=friendly,distance=..1.5] run scoreboard players add #xp var 3
