...
execute at @e[type=armor_stand,tag=hovered.slot,tag=id,limit=1] run fill ~ ~1 ~ ~ ~1 ~ spawner{SpawnCount:0,SpawnRange:0,MaxNearbyEntities:0,RequiredPlayerRange:0,SpawnData:{id:"minecraft:silverfish"}} replace air
