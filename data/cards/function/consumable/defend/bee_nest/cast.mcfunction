...
tellraw @a[tag=id] {"translate":"cast.use",color:green,"with":[{"selector":"@s"},{"underlined":true,"translate":"card.bee_nest","hover_event":{"action":"show_item","id":"minecraft:carrot_on_a_stick","count":1,"components":{"minecraft:item_name":{"color":"green","translate":"card.bee_nest"},"minecraft:lore":[[{"translate":"cost","italic":false,"color":"white"},{"text":" 6","italic":false,"color":"white"}],{"text":"","color":"white","italic":false},{"translate":"card.bee_nest.lore.0","color":"white","italic":false},{"translate":"card.bee_nest.lore.1","color":"white","italic":false},{"translate":"card.bee_nest.lore.2","color":"white","italic":false},{"translate":"card.bee_nest.lore.3","color":"white","italic":false}]}}}]}
