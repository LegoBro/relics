...
execute at @e[type=armor_stand,tag=hovered.slot,tag=filled,tag=id,limit=1] run summon potion ~ ~5 ~ {Item:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:healing",Enchantments:[{}]}}}
