...
execute at @n[type=armor_stand,tag=hovered.slot,tag=filled,tag=id,distance=..100] run summon splash_potion ~ ~5 ~ {Item:{id:"minecraft:splash_potion",count:1b,components:{potion_contents:"minecraft:healing"}}}
