...
execute at @e[type=armor_stand,tag=hovered.slot,tag=filled,tag=id,limit=1] run summon splash_potion ~ ~6 ~ {Item:{id:"minecraft:splash_potion",count:1b,components:{potion_contents:"minecraft:poison"}}}
