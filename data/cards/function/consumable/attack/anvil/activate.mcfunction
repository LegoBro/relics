...
execute at @e[type=armor_stand,tag=hovered.slot,tag=filled,tag=id,limit=1] run summon armor_stand ~ ~6 ~ {Invisible:1b,Tags:["animation","fall"],equipment:{head:{id:"minecraft:rail",count:1b}}}
