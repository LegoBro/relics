...
execute as @e[type=armor_stand,tag=board,tag=id,tag=!filled,tag=!blocked,tag=!block,sort=random,limit=1,tag=!z0,tag=!z6,tag=!draw_pile,tag=!discard_pile] run tag @s add destination
