...
summon phantom ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","phantom","card.entity","card.end","attackable"],Team:"green",ActiveEffects:[{Id:12b,Amplifier:1b,Duration:2000000,ShowParticles:0b}]}
...
scoreboard players set @e[tag=get_id,limit=1,sort=nearest] attack 4
