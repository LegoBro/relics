...
summon skeleton ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","skeleton","card.entity","card.overworld","attackable"],Team:"green",ArmorItems:[{},{},{},{id:"minecraft:book",Count:1b}],HandItems:[{id:"minecraft:bow",Count:1b},{}]}
