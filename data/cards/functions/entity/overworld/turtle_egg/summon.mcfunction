...
summon armor_stand ~ ~1 ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","turtle_egg","card.entity","card.overworld","attackable"],Team:"green",CustomName:"{\"text\":\"Turtle Egg\"}",Marker:1b,Invisible:1,DisabledSlots:4144959}
