...
tellraw @a[tag=id] [{"selector":"@s"},{"text":" uses "},{"underlined":true,"translate":"card.bee_nest","hoverEvent":{"action":"show_item","contents":{"id":"minecraft:carrot_on_a_stick","Count":1,"tag":"{HideFlags:127,display:{Lore:['','[{\"translate\":\"cost\",\"italic\":false,\"color\":\"white\"},{\"text\":\" 6\",\"italic\":false,\"color\":\"white\"}]','{\"text\":\"\",\"color\":\"white\",\"italic\":false}','{\"translate\":\"card.bee_nest.lore.0\",\"color\":\"white\",\"italic\":false}','{\"translate\":\"card.bee_nest.lore.1\",\"color\":\"white\",\"italic\":false}','{\"translate\":\"card.bee_nest.lore.2\",\"color\":\"white\",\"italic\":false}','{\"translate\":\"card.bee_nest.lore.3\",\"color\":\"white\",\"italic\":false}'],Name:\"{\\\"translate\\\":\\\"card.bee_nest\\\",\\\"italic\\\":false,\\\"color\\\":\\\"green\\\"}\"}}"}}}]
summon armor_stand ~ ~1 ~ {CustomName:'{"translate":"card.bee_nest"}',Invisible:1b,PersistenceRequired:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["new","get_id","id","card","bee_nest","card.building","card.defend","attackable"],Team:"green"}
