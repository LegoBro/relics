...
execute at @e[type=armor_stand,tag=hovered.slot,tag=id,limit=1] positioned ~ ~1 ~ run function cards:consumable/defend/bee_nest/set
...
function cards:entity/overworld/bee/discover